# PhoinFirewall (C++ + libpcap)

`PhoinFirewall` — это простой IDS/IPS-скрипт на **C++ + libpcap**, который анализирует входящий трафик в реальном времени и обнаруживает (и при необходимости блокирует) **мультивекторные DDoS-атаки** уровня **L3/L4/L7**.
...
`ddos_combo_guard` - собранный исполняемый файл
